        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    .disabled(appState.phoneNumber.isEmpty)
                    ...
                    Text("点击后将拨号，需手动按通话键确认。iOS 不允许自动拨号。")
                }
                ...
                Section {
                    VStack(alignment: .leading, spacing: 12) {
                        InfoRow(icon: "rectangle.3.group", title: "添加小组件",
                                desc: "在主屏幕长按 → 点击 + → 搜索「呼叫转移」→ 添加小组件")
                        InfoRow(icon: "controlcenter", title: "控制中心",
                                desc: "iOS 18+ 可在控制中心添加 Widget，下拉即可使用")
            ...
            .alert("操作提示", isPresented: $appState.showActionAlert) {
